...
public class ResortService {
  ...
  public void handleResortsGetRequest(HttpServletRequest request,
    ...
    ResortsList resortsList = resortDao.selectAllResorts();
  ...
  public void handleNumberOfSkiersGetRequest(HttpServletRequest request,
      HttpServletResponse response) {
    ResortSkiers resortSkiers = resortDao.selectNumberOfSkiers();
    Util.response200(response, new Gson().toJson(resortSkiers));
  }
