...
import repository.ResortRedisRepository;

public class Main {

  private static ResortConsumer resortConsumer = null;
  ...
  public static void main(String[] argv) {
    try {
      ...
      IGenericRepository<LiftRide> repository = new ResortRedisRepository(jedisPool);
      resortConsumer = new ResortConsumer(connection, repository);
